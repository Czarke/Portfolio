...
<section className="experience section">
                    <div className="section-inner shadow-sm rounded">
                        ...
                        <div className="content">
                            <div className="item">
                                <h3 className="title text-left">IT Service Desk Technician - <span className="place"><a href="#">Pharmaca</a></span> <span className="year">(2020 - Present)</span></h3>
                            ...
                            <div className="item">
                                <h3 className="title text-left">Lead Student Technician - <span className="place"><a href="#">University of Colorado Boulder</a></span> <span className="year">(2016 - 2019)</span></h3>
                                <ul className="text-left">
