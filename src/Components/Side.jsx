            ...
            <aside className="education aside section">
                <div className="section-inner shadow-sm rounded">
                    ...
                    <div className="content">
                        ...
                        <div className="item">
                            <h3 className="title"><i className="fas fa-graduation-cap"></i> Certified Scrum Master</h3>
                            <h4 className="university">Scrum Alliance <span className="year">(May 2021)</span></h4>
                        </div>
                    </div>
                </div>
            </aside>
                ...
                <div className="section-inner shadow-sm rounded">
                    ...
                    <div className="content">
                        <ul className="list-unstyled">
                            ...
                            <li><i className="fas fa-headphones"></i> <a href="https://www.amazon.com/Lord-Rings-50th-Anniversary-Vol/dp/0618640150/ref=sr_1_3?crid=39U705F8430BD&dchild=1&keywords=the+lord+of+the+rings+book&qid=1624926455&sprefix=the+lord+of+the+rings%2Caps%2C213&sr=8-3">The Lord of the Rings - J.R.R. Tolkien</a></li>
                        </ul>
                    </div>
                </div>
            </aside>
